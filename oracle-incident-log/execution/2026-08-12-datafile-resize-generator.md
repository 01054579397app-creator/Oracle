...
[2026-08-12 18:00 KST] 추가 업데이트
- 오류: 수정 과정에서 `TRUNC(bytes/1024/1024)-50)`처럼 닫는 괄호가 하나 더 들어가 ORA-00923 발생.
- 수정: `(TRUNC(bytes/1024/1024) - 50)`으로 산술식 전체를 묶고, 데이터파일 이름은 생성 SQL에서 작은따옴표로 감쌈.
